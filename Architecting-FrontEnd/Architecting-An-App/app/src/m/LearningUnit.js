...
vt.m.LearningUnit.add = function (slots) {
  slots.learnUnitNo = parseInt( slots.learnUnitNo);
...
vt.m.LearningUnit.destroy = function (learnUnitNo) {
  if (vt.m.LearningUnit.instances[String( slots.learnUnitNo)]) {
    delete vt.m.LearningUnit.instances[String( slots.learnUnitNo)];
